    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_car_venta', to='producto.producto', verbose_name='producto')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_invoce', models.CharField(choices=[('0', 'Nota de Venta'), ('1', 'Boleta'), ('2', 'Factura'), ('3', 'Sin Comprobante')], max_length=2, verbose_name='TIPO')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ('count', models.PositiveIntegerField(verbose_name='Cantidad')),
                ('purchase_price', models.DecimalField(decimal_places=3, max_digits=10, verbose_name='Precio Compra')),
                ('sale_price', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Precio Venta')),
                ('tax', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='Impuesto')),
                ('anulate', models.BooleanField(default=False)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_sale', to='producto.producto', verbose_name='producto')),
