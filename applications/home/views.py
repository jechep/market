...
#
from .forms import LiquidacionClienteForm, ResumenVentasForm
#
...
class ReporteLiquidacion(AdminPermisoMixin, ListView):
    ...
    extra_context = {'form': LiquidacionClienteForm}
    
    def get_queryset(self):
        
        lista_ventas, total_ventas = SaleDetail.objects.resumen_ventas_cliente(
